  ...
  return (
    <div className="w-full dark:bg-gray-900 transition-colors duration-300 [@media(display-mode:standalone)]:pb-24">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-3xl p-8 shadow-lg relative overflow-hidden transition-colors duration-300">
            <Link to="/my-tasks">
              <div className="bg-green-50 dark:bg-gray-700 p-6 rounded-2xl shadow-md mb-4 hover:shadow-lg transition cursor-pointer">
                <h4 className="font-semibold text-gray-800 dark:text-white">Pending Tasks</h4>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Link to="/my-tasks">
              <div className="p-6 rounded-2xl border border-gray-100 dark:border-gray-700 shadow-sm hover:shadow-md transition cursor-pointer text-center group h-full dark:bg-gray-800">
                ...
                <h3 className="text-xl font-bold text-gray-800 dark:text-white mb-2">My Tasks</h3>
                <p className="text-gray-600 dark:text-gray-300">View and manage all complaints assigned to your zone.</p>
              </div>
            </Link>
            ...
            <Link to="/map-view">
              <div className="p-6 rounded-2xl border border-gray-100 dark:border-gray-700 shadow-sm hover:shadow-md transition cursor-pointer text-center group h-full dark:bg-gray-800">
                ...
                <h3 className="text-xl font-bold text-gray-800 dark:text-white mb-2">Map View</h3>
                <p className="text-gray-600 dark:text-gray-300">Visualize complaint locations on an interactive map.</p>
              </div>
            </Link>
            ...
            <Link to="/broadcast-alert">
              <div className="p-6 rounded-2xl border border-gray-100 dark:border-gray-700 shadow-sm hover:shadow-md transition cursor-pointer text-center group h-full dark:bg-gray-800">
                ...
                <h3 className="text-xl font-bold text-gray-800 dark:text-white mb-2">Broadcast Alert</h3>
                <p className="text-gray-600 dark:text-gray-300">Send notifications to citizens in your area about maintenance.</p>
              </div>
            </Link>
          </div>
        </div>
      ...
      <section className="bg-green-50 dark:bg-gray-800 py-16 px-6 transition-colors duration-300">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl font-bold text-gray-800 dark:text-white mb-8 text-center">Recent Notifications</h2>
          <div className="bg-white dark:bg-gray-700 rounded-2xl p-6 shadow-md transition-colors duration-300">
            <ul className="space-y-4">
              <li className="flex items-center justify-between border-b border-gray-100 dark:border-gray-600 pb-3 last:border-0 last:pb-0">
                <div className="flex items-center gap-3">
                  <span className="w-2 h-2 bg-red-500 rounded-full"></span>
                  <div>
                    <p className="text-gray-800 dark:text-white font-bold">High Priority: Water Leakage</p>
                    <p className="text-sm text-gray-500 dark:text-gray-300">Sector 4, Main Pipeline. Reported 30 mins ago.</p>
                  </div>
                </div>
              ...
              <li className="flex items-center justify-between border-b border-gray-100 dark:border-gray-600 pb-3 last:border-0 last:pb-0">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-gray-800 dark:text-white font-bold">New Assignment: Street Light</p>
                    <p className="text-sm text-gray-500 dark:text-gray-300">MG Road, Pole #45. Reported 2 hours ago.</p>
                  </div>
                </div>
              ...
              <li className="flex items-center justify-between border-b border-gray-100 dark:border-gray-600 pb-3 last:border-0 last:pb-0">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-gray-800 dark:text-white font-bold">Complaint Resolved Verified</p>
                    <p className="text-sm text-gray-500 dark:text-gray-300">Garbage Collection at Block C confirmed by supervisor.</p>
                  </div>
                </div>
      ...
      <section className="bg-white dark:bg-gray-900 py-16 px-6 transition-colors duration-300">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl font-bold text-gray-800 dark:text-white mb-12 text-center">Your Performance</h2>
          <div className="grid md:grid-cols-4 gap-6">
            <div className="bg-green-50 dark:bg-gray-800 p-6 rounded-xl text-center border border-green-100 dark:border-gray-700">
              <h3 className="text-4xl font-bold text-green-600 mb-2">95%</h3>
              <p className="text-gray-600 dark:text-gray-300 font-medium">Resolution Rate</p>
            </div>
            <div className="bg-green-50 dark:bg-gray-800 p-6 rounded-xl text-center border border-green-100 dark:border-gray-700">
              <h3 className="text-4xl font-bold text-green-600 mb-2">24h</h3>
              <p className="text-gray-600 dark:text-gray-300 font-medium">Avg Response Time</p>
            </div>
            <div className="bg-green-50 dark:bg-gray-800 p-6 rounded-xl text-center border border-green-100 dark:border-gray-700">
              <h3 className="text-4xl font-bold text-green-600 mb-2">4.8</h3>
              <p className="text-gray-600 dark:text-gray-300 font-medium">Citizen Rating</p>
            </div>
            <div className="bg-green-50 dark:bg-gray-800 p-6 rounded-xl text-center border border-green-100 dark:border-gray-700">
              <h3 className="text-4xl font-bold text-green-600 mb-2">120</h3>
              <p className="text-gray-600 dark:text-gray-300 font-medium">Complaints Solved</p>
            </div>
          </div>
        </div>
      </section>
