...
import { User, BadgeCheck, Mail, Lock, ArrowLeft, ShieldAlert } from 'lucide-react'
    ...
    <div className="min-h-screen bg-green-50 flex items-center justify-center p-6">
      <div className="max-w-4xl w-full bg-white rounded-3xl shadow-2xl overflow-hidden flex flex-col md:flex-row">
        ...
        <div className="md:w-1/2 p-8 md:p-12 flex flex-col justify-center relative">
          ...
          <h2 className="text-3xl font-bold text-gray-800 mb-1 mt-8">Officer Registration</h2>
          <p className="text-gray-500 mb-6">Enter your official details</p>
          <form className="space-y-4" onSubmit={handleRegister}>
            ...
            <div className="relative"><BadgeCheck className="absolute left-3 top-3.5 text-gray-400" size={20} /><input type="text" placeholder="Badge ID / Employee ID" className="w-full p-3 pl-10 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-600" /></div>
            <div className="relative"><Mail className="absolute left-3 top-3.5 text-gray-400" size={20} /><input type="email" placeholder="Official Email" className="w-full p-3 pl-10 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-600" /></div>
          ...
          <div className="text-center border-t border-gray-200 pt-4 mt-4">
            <p className="text-gray-600 mb-2">Already registered?</p>
