            ...
            <div className="max-w-4xl w-full bg-white dark:bg-gray-800 rounded-3xl shadow-2xl overflow-hidden flex flex-col md:flex-row transition-colors duration-300">
                ...
                <div className="md:w-1/2 p-6 md:p-12 flex flex-col justify-center relative">
                    ...
                    <form className="space-y-4" onSubmit={handleRegister}>
                        ...
                        <div>
                            <div className="relative"><Phone className="absolute left-3 top-3.5 text-gray-400" size={20} /><input type="tel" placeholder="Phone Number" className={`w-full p-3 pl-10 border ${errors.phone ? 'border-red-500' : 'border-gray-300'} dark:border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-600 dark:bg-gray-700 dark:text-white`} value={phone} onChange={(e) => setPhone(e.target.value)} /></div>
                    ...
                    <div className="text-center border-t border-gray-200 pt-4 mt-4">
                        ...
                        <Link to="/login-civilian" className="text-green-600 font-bold hover:underline">Sign In</Link>
                    </div>
                </div>
            </div>
        </div>
