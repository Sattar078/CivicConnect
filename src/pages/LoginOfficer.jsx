        ...
        <div className="min-h-screen bg-green-50 dark:bg-gray-900 flex items-center justify-center p-6 transition-colors duration-300">
            <div className="max-w-4xl w-full bg-white dark:bg-gray-800 rounded-3xl shadow-2xl overflow-hidden flex flex-col md:flex-row transition-colors duration-300">
                <div className="md:w-1/2 bg-gradient-to-br from-green-600 to-green-400 p-10 text-white flex flex-col justify-center items-center relative overflow-hidden">
                    ...
                    <p className="text-lg opacity-90 text-center">Secure access for municipal officers. Manage your assigned tasks effectively.</p>
                ...
                <div className="md:w-1/2 p-6 md:p-12 flex flex-col justify-center relative">
                    ...
                    <h2 className="text-3xl font-bold text-gray-800 dark:text-white mb-1 mt-8">Officer Login</h2>
                    <p className="text-gray-500 dark:text-gray-400 mb-6">Please sign in to continue</p>
                    <form className="space-y-5" onSubmit={handleLogin}>
                        <div>
                            <label className="block text-gray-700 dark:text-gray-300">Official Email</label>
                            <div className="relative">
                                <Mail className="absolute left-3 top-4 text-gray-400" size={20} />
                                <input
                                    type="email"
                                    className={`w-full mt-1 p-3 pl-10 border ${errors.email ? 'border-red-500' : 'border-gray-300'} dark:border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-600 dark:bg-gray-700 dark:text-white`}
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input
                                    type="password"
                                    className={`w-full mt-1 p-3 pl-10 border ${errors.password ? 'border-red-500' : 'border-gray-300'} dark:border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-600 dark:bg-gray-700 dark:text-white`}
                        ...
                        <div className='text-center pt-2'>
                            <p className="text-gray-600 dark:text-gray-400 mb-2">New Officer?</p>
                            <Link to="/register-officer" className="text-green-600 font-bold hover:underline">Register Here</Link>
                        </div>
                    </form>
                </div>
            </div>
