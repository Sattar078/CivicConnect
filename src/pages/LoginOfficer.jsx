    ...
    <div className="min-h-screen bg-green-50 flex items-center justify-center p-6">
      <div className="max-w-4xl w-full bg-white rounded-3xl shadow-2xl overflow-hidden flex flex-col md:flex-row">
        ...
        <div className="md:w-1/2 p-8 md:p-12 flex flex-col justify-center relative">
          ...
          <h2 className="text-3xl font-bold text-gray-800 mb-1 mt-8">Officer Login</h2>
          ...
          <form className="space-y-5" onSubmit={handleLogin}>
            <div>
              ...
              <div className="relative">
                ...
                <input type="email" className="w-full mt-1 p-3 pl-10 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-600" placeholder="officer@civic.gov" required />
              </div>
            </div>
            <div>
              ...
              <div className="relative">
                ...
                <input type="password" className="w-full mt-1 p-3 pl-10 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-600" placeholder="Enter password" required />
              </div>
            </div>
            ...
            <div className='text-center pt-2'>
               <p className="text-gray-600 mb-2">New Officer?</p>
               <Link to="/register-officer"><button className="text-green-600 font-bold hover:underline">Register Here</button></Link>
            </div>
          </form>
        </div>
      </div>
