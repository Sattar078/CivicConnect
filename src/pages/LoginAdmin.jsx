...
const LoginAdmin = () => {
    ...
    const handleLogin = (e) => {
        ...
        const admin = {
            ...
            email: email,
            adminId: existingUser.adminId || 'ADM-001',
            role: existingUser.role || 'System Administrator',
            lastLogin: 'Just Now'
        };
                ...
                <div className="md:w-1/2 p-6 md:p-12 flex flex-col justify-center relative">
                    ...
                    <form className="space-y-5" onSubmit={handleLogin}>
                        ...
                        <div className='text-center pt-2'>
                            ...
                            <Link to="/register-admin" className="text-green-600 font-bold hover:underline">Register Here</Link>
                        </div>
                    </form>
                </div>
            </div>
